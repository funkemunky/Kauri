...
public class VelocityH extends Check {
    public VelocityH(String name, CheckType type, CancelType cancelType, int maxVL) {
    ...
    public Object onPacket(Object packet, String packetType, long timeStamp) {
        ...
        if(getData().getVelocityProcessor().getLastVelocity().hasPassed(2)) return packet;
        ...
        val noneCollide = getData().getBoundingBox().grow(1, 0, 1).getCollidingBlocks(player).stream().noneMatch(BlockUtils::isSolid);

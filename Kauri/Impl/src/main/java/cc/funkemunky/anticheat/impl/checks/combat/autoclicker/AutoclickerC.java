...
@CheckInfo(name = "Autoclicker (Type C)", description = "Checks if the autoclicker clicks in a specific range set.", type = CheckType.AUTOCLICKER, cancelType = CancelType.INTERACT, maxVL = 4, executable = true)
@Init

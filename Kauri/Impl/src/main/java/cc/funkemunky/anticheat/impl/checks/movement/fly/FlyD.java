...
public class FlyD extends Check {
    ...
    public void onPacket(Object packet, String packetType, long timeStamp) {
        ...
        if(!getData().isGeneralCancel() && !move.isServerOnGround() && getData().getLastBlockPlace().hasPassed(30) && move.getBlockAboveTicks() == 0 && move.getWebTicks() == 0 && move.getHalfBlockTicks() == 0 && move.getLiquidTicks() == 0 && move.getClimbTicks() == 0) {
            if(ticks++ >= 10) {

...
public class CheckManager {
    ...
    public List<Check> loadChecks() {
        ...
        registerCheck(checks, new AimF("Aim (Type F)", "Finds any suspiciously consistent variables.", CheckType.AIM, CancelType.COMBAT, 150, false, false, false));
        registerCheck(checks, new AimG("Aim (Type G)", "Checks for common denominators in the yaw.", CheckType.AIM, CancelType.COMBAT, 125, true, false, false));
        registerCheck(checks, new AimH("Aim (Type H)", "Looks for a common angle mistake in clients. By Itz_Lucky.", CheckType.AIM, CancelType.COMBAT, 10, true, true, true));
        ...
        registerCheck(checks, new JesusA("Jesus (Type A)", "Looks for consistency in y movement in water.", CheckType.JESUS, CancelType.MOTION, 50, true, true, true));
        ...
        registerCheck(checks, new StepA("Step (Type A)", "Checks for illegitimate collisions.", CheckType.STEP, CancelType.MOTION, 50, true, false, false));
        ...
        registerCheck(checks, new BadPacketsB("BadPackets (Type H)", "Looks for any invalid movements related to inventory windows.", CheckType.BADPACKETS, CancelType.MOTION, 150, true, false, true));

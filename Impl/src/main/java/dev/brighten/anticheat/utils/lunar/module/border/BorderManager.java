...
import dev.brighten.anticheat.utils.lunar.listener.BorderListener;
...
public class BorderManager {
    ...
    public BorderManager(){
        ...
        Kauri.INSTANCE.getServer().getPluginManager().registerEvents(new BorderListener(), Kauri.INSTANCE);
    }

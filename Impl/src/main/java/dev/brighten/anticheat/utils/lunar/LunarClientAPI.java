package dev.brighten.anticheat.utils.lunar;

import dev.brighten.anticheat.Kauri;
import lombok.Getter;
import lombok.Setter;
import dev.brighten.anticheat.utils.lunar.module.border.BorderManager;
import dev.brighten.anticheat.utils.lunar.module.hologram.HologramManager;
import dev.brighten.anticheat.utils.lunar.module.waypoint.WaypointManager;
import dev.brighten.anticheat.utils.lunar.user.User;
import dev.brighten.anticheat.utils.lunar.user.UserManager;
import dev.brighten.anticheat.utils.lunar.util.type.Notification;
import dev.brighten.anticheat.utils.lunar.util.type.ServerRule;
...
public class LunarClientAPI {
    ...
    @Getter
    private static LunarClientAPI instance = new LunarClientAPI();
        ...
        if (everyone) {
            for (Player other : Bukkit.getServer().getOnlinePlayers()) {
                if (LunarClientAPI.getInstance().isAuthenticated(other)) {
                    other.sendPluginMessage(Kauri.INSTANCE, "Lunar-Client", os.toByteArray());
                }
            }
        } else {
            player.sendPluginMessage(Kauri.INSTANCE, "Lunar-Client", os.toByteArray());

...
public class SpeedC extends Check {
    ...
    public void onPacket(WrappedInFlyingPacket packet) {
        ...
        baseSpeed += data.playerInfo.iceTimer.isNotPassed(70)
                ? 0.4 + (Math.min(60, 60 - data.playerInfo.iceTimer.getPassed()) * 0.015)
                : 0;
        baseSpeed += data.playerInfo.blockAboveTimer.isNotPassed(20)
                ? 0.35 + ((20 - data.playerInfo.blockAboveTimer.getPassed()) * 0.005)
                : 0;
